...
'Parameter 1, sent from calling batch file - \\Geobase-win\CED\GADS\R2018\R067\UpdateData\UpdateData.bat
FileToBeUsed = Arg(0)
'msgbox "First parameter passed was " & FileToBeUsed

Dim PublicLink, NetworkLink
PublicLink = "https://wspdsmap.cityoftacoma.org/website/PDS/LandUse/"
NetworkLink = "\\Geobase-win\CED\GADS\R2018\R067\UpdateData\UpdateData.bat"
...
objCDO1.Textbody = "Please review Tacoma Land Use Permits Update Report below. " & vbCrLf & vbCrLf _
			& "Today's Log File: " & FileToBeUsed & vbCrLf & vbCrLf _
			& "View updated Land Use Permits App: " & PublicLink & vbCrLf _
			& "Rerun Tacoma Land Use Permits Update Report: " & NetworkLink & vbCrLf _
			& f.ReadAll

f.Close
objCDO1.TO ="mmurnane@cityoftacoma.org"
objCDO1.From = "mmurnane@cityoftacoma.org"
objCDO1.Subject = "Land Use Permits Update Report"
